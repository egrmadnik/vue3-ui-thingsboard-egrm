export default {
  ...
  cardList: {
    pageSizeLabel: '每页显示数量',
    refresh: '刷新',
    editClicked: '你点击了编辑图标',
    deleteLabel: '删除',
  ...
  form: {
    ...
    errors: {
      missingDataIndex: '必须包含 dataIndex 字段。',
      invalidResetSchema: '重载的元素不能是 None、Divider 或 FormGroup 组件，必须包含 field 字段。',
      invalidUpdateSchema: '更新的元素不能是 None、Divider 或 FormGroup 组件，必须包含 field 字段。',
    },
  },
  icon: {
    placeholder: '点击选择图标',
