export default {
  ...
  cardList: {
    ...
    refresh: 'Refresh',
    editClicked: 'You clicked the edit icon',
    deleteLabel: 'Delete',
  ...
  form: {
    ...
    errors: {
      missingDataIndex: 'Must include the dataIndex field.',
      invalidResetSchema:
        'The reloaded elements cannot be None, Divider, or FormGroup components, and must include the field property.',
      invalidUpdateSchema:
        'Updated elements cannot be None, Divider, or FormGroup components, and must include the field property.',
    },
  },
  icon: {
